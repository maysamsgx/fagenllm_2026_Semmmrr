...
4. **Stage 2 — Semantic**: Re-score with MiniLM embeddings via PGVector; match if similarity ≥ 0.75
5. **Stage 3 — FX Variance**: If semantic similarity ≥ 0.50 but amounts differ by ≤ 2%, reconcile as FX variance
...
- **Semantic match**: embedding similarity ≥ 0.75 (`RECON.semantic_match_threshold`)
